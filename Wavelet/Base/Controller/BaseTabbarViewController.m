...
@interface BaseTabbarViewController ()<UIGestureRecognizerDelegate>
...
//    [self.tabView setHidden:YES];
    ...
    self.tabView = [[MainTabBaseView alloc] initWithFrame:CGRectMake(0, HEIGHT - 49 - 64, WIDTH, 49) withVC:self.navigationController];
